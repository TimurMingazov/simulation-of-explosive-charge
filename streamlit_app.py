...
from dz_eco_3 import run as run_eco_dz3
...
def main():
    ...
    option = st.selectbox(
        ...
        ("Лабораторная 1 ДСП", "Лабораторная 2 ДСП", "Лабораторная 3 ДСП", "Домашняя работа 2 Технология приборостроения", 
         "Домашняя работа 3 Технология приборостроения", "ДЗ 1 Экономика предприятия", "ДЗ 2 Экономика предприятия",
         "Лабораторная 1 РадиоПередачаИнфы", "ДЗ 3 Экономика предприятия")
    )
    ...
    if option == "Лабораторная 1 ДСП":
        ...
        run_eco_dz2()
    elif option == "ДЗ 3 Экономика предприятия":
        run_eco_dz3()
